    ...
    if line_type == "line":
        ...
        for index, component in enumerate(story_data['story_components'][1:], start=1):
            ...
            #curve is too long so need to shorten it
                ...
                print("1. original_arc_end_time_values[-1] : ", original_arc_end_time_values[-1] )
                print("1. original_arc_end_emotional_score_values[-1] : ", original_arc_end_emotional_score_values[-1])

                original_arc_end_time_index_length = len(original_arc_end_time_values) - 2
                original_arc_end_emotional_score_index_length = len(original_arc_end_emotional_score_values) - 2
                ...
                if (original_arc_end_time_values[-1] >= old_min_x 
                    ...
                    print("2. original_arc_end_time_values[-1] : ", original_arc_end_time_values[-1] )
                    print("2. original_arc_end_emotional_score_values[-1] : ", original_arc_end_emotional_score_values[-1])
