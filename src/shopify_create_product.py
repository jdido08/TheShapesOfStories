import os, json, requests, yaml, time
...
def create_shopify_product(story_data_path, product_type):
    ...
    if product_type == "print":
        product_category =  "gid://shopify/TaxonomyCategory/hg-3-4-2-2" # this is Shopify preset Categories I'm choosing Home & Garden > Decor > Artwork > Prints, Posters & Visual Artwork > Prints
    ...
    shopify_product_id = create_product_and_set_metafields(product_input, product_metafields, product_options)
    
    story_data['shopify_product_id'] = shopify_product_id #save shopify product id back to story_data
...
## TEST TO GET PRODUCT CATEGORY FOR PRINTS
...
# handle = "the-stranger-meursault-print"  # or any product handle from your store
# res = gql(Q, {"handle": handle})
