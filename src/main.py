...
create_shape(story_data_path = '/Users/johnmikedidonato/Projects/TheShapesOfStories/the_great_gatsby.json',
                ...
                font_color = (0.83, 0.69, 0.22), #only used if line_type set to char
                background_type='solid', #values solid or transparent
                background_value=(0, 0.12, 0.25), #only used if background_type = solid
                ...
                title_font_color = (0.83, 0.69, 0.22), #only used if has_title = "YES"
