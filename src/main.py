...
create_shape(story_data_path = '/Users/johnmikedidonato/Projects/TheShapesOfStories/archetypes_data/boy_meets_girl.json',
                product= "poster",
                ...
                line_thickness = 100, #only used if line_type = line
                line_color = '#000000', #only used if line_type = line
                ...
                background_type='transparent', #values solid or transparent
